      ...
      <section className="hero container">
        ...
        <aside className="signal-card">
          ...
          <div className="metric-row">
            <div>
              <strong>~40%</strong>
              <span>redução no tempo de regressão</span>
            </div>
            <div>
              <strong>~35%</strong>
              <span>redução no tempo de pipeline</span>
            </div>
          </div>
          <div className="signal-line">
            <CheckCircle2 size={17} /> Web • API • E2E • Performance • CI/CD
          </div>
        </aside>
      </section>
        ...
        <div className="about-grid">
          ...
          <div className="principles">
            <div>
              <ShieldCheck />{" "}
              <span>
                <strong>Quality by design</strong>Risco, critérios e
                testabilidade desde o refinamento.
              </span>
            </div>
            <div>
              <TerminalSquare />{" "}
              <span>
                <strong>Automation with purpose</strong>Automação orientada a
                valor, estabilidade e feedback rápido.
              </span>
            </div>
            <div>
              <Sparkles />{" "}
              <span>
                <strong>Next frontier</strong>IA aplicada a QA como trilha de
                evolução, separada da experiência consolidada.
              </span>
            </div>
          </div>
        </div>
